...
var Car = /*#__PURE__*/function (_Vehicle2) {
  function Car(make, model) {
    ...
    return _callSuper(this, Car, [make, model, "four"]);
  }
  _inherits(Car, _Vehicle2);
  return _createClass(Car);
}(Vehicle);
var MotorCycle = /*#__PURE__*/function (_Vehicle3) {
  function MotorCycle(make, model) {
    _classCallCheck(this, MotorCycle);
    return _callSuper(this, MotorCycle, [make, model, 2]);
  }
  _inherits(MotorCycle, _Vehicle3);
  return _createClass(MotorCycle);
}(Vehicle);
